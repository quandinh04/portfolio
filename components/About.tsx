          ...
          <div className="description w-full md:w-3/4">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex flex-col mt-10 md:mt-0">
                <p>My name is Quan, a current junior at Purdue University, majoring in Computer Science. As of right
                now, I am still on the journey to explore Computer Science through research and coding projects, trying to find my life&aposs calling. Does it exist? Who knows.</p>
                <br />
